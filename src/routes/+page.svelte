...
<section
	class="px-wrapper h-full w-full bg-black bg-contain  bg-no-repeat pt-headerHeightMd text-white bg-none xl:bg-[url('/svgs/layout/application-bg-logo.svg')]"
>
	<div
	...
	>
		<div class="xl:ml-[50%] flex flex-col xl:w-1/2">
			<div class="mx-12">
